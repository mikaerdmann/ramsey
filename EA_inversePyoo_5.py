'''
Author: Mika Erdmann
This script contains the inverse Pyoo Model that implements the optimization of the parameters pm_cumdepr_new and pm_cumdepr_old by minimizing the difference to the EA_inverse.get_vm_opt() result.
The parameters pm_cumdepr are fixed for the periods with the same timestep length.
'''
